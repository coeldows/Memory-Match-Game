// Memory Match Game for Web Browser
// Designed to engage 30–50 year olds with nostalgic emojis
// A fast, fun, brain-boosting challenge inspired by retro tech and pop culture
// Fun, visually engaging, nostalgic and brain-stimulating
...
function startTimer() {
  ...
  timerDisplay.textContent = `Time (5 minutes): ${countdown}s`;
...
window.onload = () => {
  ...
  menu.innerHTML = `
    ...
    <div id="timer" style="margin-top: 20px; font-weight: bold; font-size: 18px;">Time (5 minutes): 0s</div>
  `;
